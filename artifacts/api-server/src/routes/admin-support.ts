...
const DEFAULT_AI_CONFIG: Array<{ key: string; value: string; label: string; group: string }> = [
  ...
  { key: "ai_escalation_message", value: "Je vais transférer votre demande à un agent humain. Veuillez patienter ou contacter simixsupport@gmail.com", label: "Message d'escalade", group: "messages" },
