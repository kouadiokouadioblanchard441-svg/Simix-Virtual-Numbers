...
import { Shield, RefreshCw, CheckCircle2, AlertCircle, Lock, ArrowLeft } from "lucide-react";
import { GmailIcon3D } from "@/components/gmail-icon-3d";
        ...
        >
          ...
          <div className="flex justify-center mb-6">
            <motion.div
              ...
              className="relative"
            >
              <div className={`w-20 h-20 rounded-3xl flex items-center justify-center ${isInactivity ? "bg-amber-500/10 border border-amber-500/20" : "bg-white/5 border border-white/10"}`}>
                {isInactivity ? (
